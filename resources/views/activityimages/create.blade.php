...
@section('section')
    <div class="col-sm-12">
        <div class="row">
            ...
            <br /><br />
                <form class="form-horizontal" role="form" method="POST" action="/activity_images/store">
                    {{ csrf_field() }}
                    <fieldset>
                        ...
                        <div class="form-group{{ $errors->has('link') ? ' has-error' : '' }}">
                            <label for="link" class="col-md-4 col-sm-4 control-label text-right">全景链接地址</label>
