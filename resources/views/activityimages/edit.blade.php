...
@section('page_heading','图片活动信息')
@section('section')
    <div class="col-sm-12">
        @section ('image_panel_title','活动图片列表')
            ...
            <div class="row">
                <div class="col-lg-5 col-md-6 col-sm-10 col-xs-12">
                    ...
                    <ol class="text-muted">
                        ...
                        <li style="color: #a94442;">图片H5链接生成30日内有效，过期失效。</li>
                        <li>图片大小不超过800KB</li>
                    </ol>
                    ...
                    <form class="form-horizontal" role="form" method="POST" action="{{ $activity->path() }}/update">
                        ...
                        <fieldset>
                            ...
                            <div class="form-group{{ $errors->has('link') ? ' has-error' : '' }}">
                                <label for="link" class="col-md-3 col-sm-3 control-label text-right">全景链接地址</label>
...
@section('script')
    ...
    uploadobj.uploadFile({
        url: "/upload_activity_image/store",
        fileName: "myfile[]",
        maxFileSize: 0.9*1024*1024,
        multiple: true,
        maxFileCount: 10,
