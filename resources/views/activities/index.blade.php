...
@section('page_heading','全景活动')
@section('section')
    <div class="col-sm-12">
        @section ('activities_panel_title','全景活动列表')
        @section ('activities_panel_body')
            <p>
              <a href="{{ url('/activities/create') }}" class="btn btn-default btn-primary">创建活动&nbsp;<i class="fa fa-plus"></i></a>
            </p>
