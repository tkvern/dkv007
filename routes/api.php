...
Route::group(['middleware' => 'auth:api'], function () {
    ...
    header("Access-Control-Allow-Headers: Access-Control-Allow-Headers, Origin, Accept, Authorization, X-Requested-With, Content-Type, Access-Control-Request-Method, Access-Control-Request-Headers, User-Id, Order-No, Activity-No");
